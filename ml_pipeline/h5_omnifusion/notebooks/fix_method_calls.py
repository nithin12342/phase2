...
new_code = [
    ...
    "    \n",
    "    try:\n",
    "        # 1. Download Video (mp4) and Audio (wav) and Subs\n",
    ...
    "            print(f\"   ⚠️ Audio extraction issue: {e}\")\n",
    "        \n",
    "        # Find subtitles\n",
    ...
    "                            seen_lines.add(line)\n",
    "            except Exception as e:\n",
    "                print(f\"   ⚠️ Subtitle parse error: {e}\")\n",
    "        \n",
    ...
    "            \n",
    "        # 4. Process Video/Face [FIXED METHOD]\n",
    "        if os.path.exists(video_path):\n",
    "            print(\"   🎬 Processing Video/Face...\")\n",
    "            # Must extract frames first!\n",
    "            if hasattr(pipeline.video, 'extractor') and hasattr(pipeline.video.extractor, 'extract'):\n",
    ...
    "            else:\n",
    "                print(\"   ⚠️ Video extractor not found, skipping video/face.\")\n",
    "\n",
    "        # 5. Fusion & Tabular\n",
...
print("Updated H5_OmniFusion_Colab_Runner_YouTube.ipynb with correct method calls.")
